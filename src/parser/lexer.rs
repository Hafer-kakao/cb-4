...
impl C1Lexer {
    ...
    */
    ...
    /// from it
    fn next_token(&mut self) -> Option<TokenData> {
...
impl TokenDataProvider for Option<TokenData> {
    fn token_type(&self) -> Option<C1Token> {
...
#[cfg(test)]
mod tests {
    use crate::parser::C1Lexer;
    use crate::parser::C1Token;
